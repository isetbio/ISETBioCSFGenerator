...
%}
    ...
    if (isempty(neuralEngineOBJ.neuralPipeline))
        ...
        theConeMosaic = cMosaic(...
            'sizeDegs', neuralResponseParamsStruct.coneMosaicParams.fovDegs, ...
...
function impulseResponse = computePhotocurrentImpulseResponse(timeAxis)
    ...
    % in @cMosaic
    load('/Volumes/SSDdisk/MATLAB/osLinearFilters25CDM2.mat', 'osLinearFilters', 'dt');
...
function photocurrentResponses = computePhotocurrent(coneExcitationResponses, temporalSupportSeconds, noiseFlag, responseSecondsKept)
