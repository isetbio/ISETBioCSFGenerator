function dataOut = nreNoiseFreePbotopigmentExcitationsCMosaic(...
...
%
% Syntax:
%   dataOut = nreNoiseFreePbotopigmentExcitationsCMosaic(...
%    neuralEngine, noiseFreeComputeParams, sceneSequence, ...
%    sceneSequenceTemporalSupport, varargin);
%
% Description:
...
%                       nrePbotopigmentExcitationsCMosaicWithNoEyeMovements.m
...
%{
    ...
    nreParams = nreNoiseFreePbotopigmentExcitationsCMosaic()
    ...
    theNeuralEngine = neuralResponseEngine(@nreNoiseFreePbotopigmentExcitationsCMosaic, ...
