...
%{
    ...
    nreNoiseFreeParams.coneMosaicParams.timeIntegrationSeconds = ...
        sceneTemporalSupportSeconds(2)-sceneTemporalSupportSeconds(1);
    nreNoisyInstanceParams = nreNoisyInstancesPoisson;
    ...
    theneuralEngineOBJ = neuralResponseEngine(@nreNoiseFreeCMosaic, ...
        ...
        nreNoiseFreeParams, nreNoisyInstanceParams);
...
if (neuralEngineOBJ.visualizeEachCompute)
    hFig = figure(1000);
    set(hFig, 'Position', [350 700 1664 544]);
    neuralEngineOBJ.visualize(theNeuralResponses, temporalSupportSeconds, ...
        'figureHandle', hFig, ...
        'responseLabel', 'noise-free_cMosaic_responses', ...
