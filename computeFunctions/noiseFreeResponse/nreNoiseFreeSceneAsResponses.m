...
%{
    ...
    theNeuralEngineOBJ = neuralResponseEngine(@nreNoiseFreeSceneAsResponses,@nreNoisyInstancesPoisson);
    ...
    % Add Poisson noise
    instancesNum = 16;
    [noisyInstances, theResponseTemporalSupportSeconds] = theNeuralEngineOBJ.computeNoisyInstances(...
            noiseFreeResponse, ...
