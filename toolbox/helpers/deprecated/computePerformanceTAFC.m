...
%concatenate the null scene and the test scence together
theScenes = {nullScene, testScene};
[predictions, theClassifierEngine, responses] = computePerformance(theScenes, ...
    ...
    trainNoiseFlag, testNoiseFlag, 'TAFC', true, 'saveResponses', saveResponses,...
