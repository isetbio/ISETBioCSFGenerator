...
switch (opticsParams.type)
    ...
    case 'maxStrehlRatio3DoptimizedWithResidualRefractionError'
        ...
        if (abs(opticsParams.refractiveErrorDiopters)>0)
           ...
           fprintf('\n**************\n NOW adding %2.2f of defocus \n****************\n\n', ...
                 opticsParams.refractiveErrorDiopters);

           [oiEnsemble, psfEnsemble] = theMosaic.oiEnsembleGenerate(...
		            mosaicParams.eccDegs, ...
                   'zernikeDataBase', opticsParams.zernikeDataBase, ...
                   'subjectID', opticsParams.subjectID, ...
                   'pupilDiameterMM', opticsParams.pupilDiameterMM, ...
                   'refractiveErrorDiopters', theOptimalStrehlRatioDefocusAndAstigmatismDiopters(1)+opticsParams.refractiveErrorDiopters, ...
           ...
           % This is it.
	       theOptics = oiEnsemble{1,1}; 
           thePSF = psfEnsemble{1,1};
           ...
           RGCMosaicConstructor.visualize.StrehlRatioAsAFunctionOfDefocusAndAstigmatism(...
                ...
                'darkScheme', true, ...
                'backgroundIsTransparent', false, ...
                'pdfFileName', strrep(thePDFfileName, '.pdf', sprintf('with_%2.2fD_additionalDefocus.pdf', opticsParams.refractiveErrorDiopters)));
        end
