...
p.addParameter('xLimsLinearBinocularSummationResponse', [], @(x)(isempty(x) || (isnumeric(x))));
p.addParameter('xLimsBinocularEnergyPreCompressionResponse', [], @(x)(isempty(x) || (isnumeric(x))));
...
xLimsLinearBinocularSummationResponse = p.Results.xLimsLinearBinocularSummationResponse;
xLimsBinocularEnergyPreCompressionResponse = p.Results.xLimsBinocularEnergyPreCompressionResponse;
...
while (nextFlag)
    ...
    if (isempty(testedIndex))
        ...
        for eeTrain = 1:nTrainFixationalEMPaths
            ...
            [~, tempTempClassifierEngine, ~,~,~,~,~, ...
                xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = computeBinocularPerformance(...
                ...
                'conditionLabel', sprintf('train for EMpath %d, %s', eeTrain, contrastLabel), ...
                'xLimsLinearBinocularSummationResponse', xLimsLinearBinocularSummationResponse, ...
                'xLimsBinocularEnergyPreCompressionResponse', xLimsBinocularEnergyPreCompressionResponse ...
                );
        ...
        if (nTrainFixationalEMPaths == 1 && nTestFixationalEMPaths == 1)
            [predictions, ~, ~, whichAlternatives, whichResponses, ...
             whichMetaDataLeftEye, whichMetaDataRightEye, ...
             xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = computeBinocularPerformance(...
                ...
                'useMetaContrast', useMetaContrast, ...
                'binocularSummationPipeline', binocularSummationPipeline, ...
                'conditionLabel', sprintf('predict, %s', contrastLabel), ...
                'xLimsLinearBinocularSummationResponse', xLimsLinearBinocularSummationResponse, ...
                'xLimsBinocularEnergyPreCompressionResponse', xLimsBinocularEnergyPreCompressionResponse ...
                );
        ...
        elseif (nTrainFixationalEMPaths == 1 && nTestFixationalEMPaths > 1)
            ...
            for eeTest = 1:nTestFixationalEMPaths
                ...
                [predictionsTemp, ~, ~, whichAlternativesTemp, whichResponsesTemp, ...
                 whichMetaDataTempLeftEye, whichMetaDataTempRightEye, ...
                 xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = computeBinocularPerformance(...
                    theLeftEyeSceneSequences{testedIndex}, theRightEyeSceneSequences{testedIndex}, ...
                    ...
                    'useMetaContrast', useMetaContrast, ...
                    'binocularSummationPipeline', binocularSummationPipeline, ...
                    'conditionLabel', sprintf('predict for EMpath %d, %s', eeTest, contrastLabel), ...
                    'xLimsLinearBinocularSummationResponse', xLimsLinearBinocularSummationResponse, ...
                    'xLimsBinocularEnergyPreCompressionResponse', xLimsBinocularEnergyPreCompressionResponse ...
                );
            ...
            for eeTrain = 1:nTrainFixationalEMPaths
                ...
                [predictionsTemp, ~, ~, whichAlternativesTemp, whichResponsesTemp, ...
                 ...
                 xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = computeBinocularPerformance(...
                    ...
                    'useMetaContrast', useMetaContrast, ...
                    'binocularSummationPipeline', binocularSummationPipeline, ...
                    'conditionLabel', sprintf('predict for EMpath %d, %s', eeTrain, contrastLabel), ...
                    'xLimsLinearBinocularSummationResponse', xLimsLinearBinocularSummationResponse, ...
                    'xLimsBinocularEnergyPreCompressionResponse', xLimsBinocularEnergyPreCompressionResponse ...
                    );
