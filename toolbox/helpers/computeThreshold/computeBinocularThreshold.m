    ...
    if (isempty(testedIndex))
        ...
        if (nTrainFixationalEMPaths == 1 && nTestFixationalEMPaths == 1)
            [predictions, ~, ~, whichAlternatives, whichResponses, ...
             whichMetaDataLeftEye, whichMetaDataRightEye] = computeBinocularPerformance(theSceneSequences{testedIndex}, ...
                ...
                'useMetaContrast', p.Results.useMetaContrast, ...
                'conditionLabel', sprintf('train %s', contrastLabel) ...
                );
        ...
        elseif (nTrainFixationalEMPaths == 1 && nTestFixationalEMPaths > 1)
            ...
            for eeTest = 1:nTestFixationalEMPaths
                ...
                [predictionsTemp, ~, ~, whichAlternativesTemp, whichResponsesTemp, ...
                 whichMetaDataTempLeftEye, whichMetaDataTempRightEye] = computeBinocularPerformance(theSceneSequences{testedIndex}, ...
