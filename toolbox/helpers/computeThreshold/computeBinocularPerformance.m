...
if (~isempty(trainNoiseFlag) & nTrain ~= 0)
    ...
    if (isTAFC)
        ...
        if (visualizeBinocularSummation)
            ...
            ISETBinocularEngine.visualize.binocularSummationKernelsAndSignals(...
                inSampleStimResponsesCellLeftEye{2}, ...
                inSampleStimResponsesCellRightEye{2}, ...
                inSampleStimResponsesCell{2}, ...
                theBinocularSummationResponseComponentsTEST, ...
                binocularSummationPipeline, ...
                binocularSummationPipelineVisualizedResponseRanges, ...
                conditionLabel, thePDFrootDir);
        end
        ...
        for nn = 1:nScenes
            ...
            if (visualizeBinocularSummation)
                 ISETBinocularEngine.visualize.binocularSummationKernelsAndSignals(...
                    ...
                    binocularSummationPipeline, ...
                    binocularSummationPipelineVisualizedResponseRanges, ...
                    sprintf('%s\n-- scene: %d of %d --', conditionLabel, nn, nScenes), thePDFrootDir);
            end
