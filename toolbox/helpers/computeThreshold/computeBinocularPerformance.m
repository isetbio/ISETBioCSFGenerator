function [predictions, theClassifierEngine, responses, whichAlternatives, whichResponses, whichMetaDataLeftEye, whichMetaDataRightEye, ...
    xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = ...
...
if (~isempty(trainNoiseFlag) & nTrain ~= 0)
    ...
    if (isTAFC)
        ...
        [inSampleStimResponsesCell{1}, theBinocularSummationResponseComponentsNULL] = ISETBinocularEngine.compute.binocularSummationPipelineOutput(...
        ...
        [inSampleStimResponsesCell{2}, theBinocularSummationResponseComponentsTEST] = ISETBinocularEngine.compute.binocularSummationPipelineOutput(...
        ...
        if (visualizeBinocularSummation)
             ...
             [xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse] = ISETBinocularEngine.visualize.binocularSummationKernelsAndSignals(...
                inSampleStimResponsesCellLeftEye{2}, ...
                inSampleStimResponsesCellRightEye{2}, ...
                inSampleStimResponsesCell{2}, ...
                theBinocularSummationResponseComponentsTEST, ...
                binocularSummationPipeline, ...
                xLimsLinearBinocularSummationResponse, xLimsBinocularEnergyPreCompressionResponse, ...
                conditionLabel);
        end
        ...
        inSampleStimResponsesCell = ISETBinocularEngine.compute.binocularSummationPipelineOutput(...
...
if (nTest ~= 0)
    ...
    if (isTAFC)
        ...
        for nn = 1:nScenes
            ...
            [outSampleStimResponsesCell{nn},  theBinocularSummationResponseComponentsTEST]= ISETBinocularEngine.compute.binocularSummationPipelineOutput(...
        ...
        for nn = 1:nScenes
            ...
            % Concatenate Left and Right eye responses
            outSampleStimResponsesCell{nn} = ISETBinocularEngine.compute.binocularSummationPipelineOutput(...
                outSampleStimResponsesCellLeftEye{nn}, ...
                outSampleStimResponsesCellRightEye{nn}, ...
                binocularSummationPipeline);
