...
%   t_neuralResponseCompute, t_responseClassifier, computePerformanceTAFC
%
% History:
...
switch (whichNeuralEngine)
    case 'nrePhotopigmentExcitationsWithNoEyeMovements'
        ...
        slopeRangeLow = 1/logToDb;
        slopeRangeHigh = 100/logToDb;
        slopeDelta = 5/logToDb;
    ...
    case 'nreScenePhotonNoise'
        ...
        slopeRangeLow = 100/logToDb;
        slopeRangeHigh = 10000/logToDb;
        slopeDelta = 100/logToDb;
...
while (nextFlag)
    ...
    testContrast = 10 ^ (logContrast/logToDb);
