...
for iRefContrast = 1:size(referenceLMSconeContrasts,1)
    ...
    if (strcmp(presentationMode, 'static'))
        gratingSceneParams = struct( ...
                ...
                'backgroundLMSconeExcitations', backgroundLMSconeExcitations .* (1+referenceLMSconeContrast), ...
                'spectralSupport', 400:20:750, ...
                'fovDegs', stimSizeDegs, ...
                'pixelsNum', pixelsNum, ...
                'spatialEnvelope', 'rect', ...
                'spatialEnvelopeRadiusDegs', 0.45*stimSizeDegs, ...  % leave a little border to visualize the background
    ...
    for iStep = 1:setupStepsRequired
        ...
        [theNullSceneEngine, theTestSceneEngines] = configureStimulusSceneEngines(...
            theLMSconeContrastDirections, referenceLMSconeContrast, examinedSpatialFrequencyCPD, ...
            gratingSceneParams);
        ...
        switch (whichNoiseFreeNre)
            ...
            case 'mRGCMosaic'
                ...
                if (simulateHighSaturationRegime)
                    ...
                    nreNoiseFreeParams.mRGCMosaicParams.responseBias = 0.05*5;
                end
        ...
        case 'Gaussian'
            ...
            if (simulateHighSaturationRegime)
                ...
                nreNoisyInstancesParams.activationFunctionParams = struct(...
                    ...
                    'semiSaturationReponseAmplitude', 0.03*gaussianSigma, ... % only relevant for 'halfwaveSigmoidalRectifier'
        ...
        theNullSceneEngine.visualizeEachCompute = visualizeEachScene;
         ...
         if (useMetaContrast)
                ...
                [logThreshold(iChromaDirection), questObj, ~, psychometricCurveParams(iChromaDirection,:)] = ...
                    ...
                    'TAFC', true, ...
                    'alternateNullSceneEngine', theNullSceneMetaEngine, ...
            ...
            [logThreshold(iChromaDirection), questObj, ~, psychometricCurveParams(iChromaDirection,:)] = ...
                    ...
                    classifierEngineParams, thresholdPara, questEnginePara, ...
                    'TAFC', true, ...
                    'alternateNullSceneEngine', theNullSceneEngine, ...
                    'useMetaContrast', useMetaContrast, ...
                    'trainFixationalEM', trainFixationalEMObj, ...
                    'testFixationalEM', testFixationalEMObj, ...
                    'verbose', verbose, ...
